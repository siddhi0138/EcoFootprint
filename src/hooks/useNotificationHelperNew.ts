...
import { Bell, Award, ShoppingCart, BookOpen, Users, Leaf, Target, Zap, TrendingUp, AlertCircle, Gift } from 'lucide-react';

export const useNotificationHelperNew = () => {
  ...
  const addRewardNotification = (rewardName: string) => {
    addNotification({
      type: 'reward',
      title: 'Reward Redeemed!',
      message: 'You have successfully redeemed the "' + rewardName + '" reward. Enjoy your benefits!',
      read: false,
      source: 'rewards',
      actionable: true,
      action: 'View Rewards',
