  ...
  return (
    <footer className="bg-green-950 text-gray-300 py-12 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        {/* Brand */}
        <div>
          <h2 className="text-2xl font-bold text-white mb-4">EcoScope</h2>
        ...
        <div>
          ...
          <div className="flex space-x-4 mb-4">
            {/* Facebook - not linked yet, no page to send visitors to */}
            <span className="text-gray-400 cursor-default" aria-label="Facebook (coming soon)" title="Coming soon">
            ...
            {/* Twitter - not linked yet, no page to send visitors to */}
            <span className="text-gray-400 cursor-default" aria-label="Twitter (coming soon)" title="Coming soon">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Instagram - not linked yet, no page to send visitors to */}
            <span className="text-gray-400 cursor-default" aria-label="Instagram (coming soon)" title="Coming soon">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
