...
const Hero = ({ onGetStarted }) => {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 dark:from-gray-900 dark:via-gray-800 dark:to-emerald-900 min-h-screen transition-colors duration-300 pt-20"> {/* Added padding top */}
      ...
      <div className="container mx-auto px-4 py-20 relative z-10"> {/* Added padding top here as well */}
