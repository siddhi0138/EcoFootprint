      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="text-center max-w-6xl mx-auto">
          ...
          <div className="mb-8 inline-flex">
            <Badge className="bg-white/20 backdrop-blur-md border border-white/30 text-emerald-700 px-8 py-3 text-base font-medium shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
          ...
          <p className="text-xl md:text-2xl text-slate-600 mb-14 max-w-4xl mx-auto leading-relaxed font-light tracking-wide">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-20">
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="text-xl px-12 py-6 border-2 border-emerald-200/50 bg-white/30 backdrop-blur-sm text-emerald-700 hover:border-emerald-400 hover:bg-white/50 hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-1 rounded-2xl"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-24">
            <div className="group text-center p-8 bg-white/40 backdrop-blur-xl rounded-3xl border border-white/20 shadow-xl hover:shadow-2xl hover:bg-white/50 transition-all duration-500 hover:transform hover:scale-105 hover:-translate-y-2">
              ...
              <div className="text-slate-600 font-medium">Products Analyzed</div>
            </div>
            ...
            <div className="group text-center p-8 bg-white/40 backdrop-blur-xl rounded-3xl border border-white/20 shadow-xl hover:shadow-2xl hover:bg-white/50 transition-all duration-500 hover:transform hover:scale-105 hover:-translate-y-2">
              ...
              <div className="text-slate-600 font-medium">Eco Warriors</div>
            </div>
            ...
            <div className="group text-center p-8 bg-white/40 backdrop-blur-xl rounded-3xl border border-white/20 shadow-xl hover:shadow-2xl hover:bg-white/50 transition-all duration-500 hover:transform hover:scale-105 hover:-translate-y-2">
              ...
              <div className="text-slate-600 font-medium">CO₂ Prevented</div>
            </div>
